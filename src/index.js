...
// Nella index.js, che è il javascript che alimenta l'unico html esposto, cioè l'index.html presente nella cartella public, devo iniettare lo state di Redux, dai file index presenti in reducers e in store, perchè quelle in Redux sono dipendenze, vanno quindi iniettate come tali nei file principali dell'applicazione
...
// Provider necessita di una singola prop, generalmente chiamate "store" il cui valore p il risultato di un configureStore()
